...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        thrusterPrefab = this.gameObject.transform.GetChild(0).gameObject;
        shieldPrefab = this.gameObject.transform.GetChild(1).gameObject;
        lives = 3;
        speed = 5.0f;
        weaponType = 1;
    ...
    void Movement()
    {
        ...
        if (transform.position.y <= -verticalScreenSize || transform.position.y > 0*verticalScreenSize)
        {
